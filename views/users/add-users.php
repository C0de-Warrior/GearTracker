...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>GearTracker | Add User</title>
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="../dashboard/main-dash.php" class="header-logo">
                  <img src="../../assets/images/favicon.png" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">GearTracker</h5>
              </a>
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number" class="form-control" placeholder="Enter Phone No" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Sport *</label>
                                        <input type="text" name="sport" class="form-control" placeholder="Enter Sport" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-12">                      
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="id" class="form-control" placeholder="Enter User Name" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">                      
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a href="../policies/privacy-policy.html">Privacy Policy</a></li>
                                <li class="list-inline-item"><a href="../policies/terms-of-service.html">Terms of Use</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-6 text-right">
                            <span class="mr-1"><script>document.write(new Date().getFullYear())</script>©</span> <a href="../dashboard/main-dash.php" class="">GearTracker</a>.
                        </div>
                    </div>
                </div>
            </div>
